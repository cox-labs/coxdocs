...
Examines the influence of two independent categorical variables on each profile.

Output: Same matrix with three p-value columns added
...
![](images/tests-three-way_anova-edited.png)
