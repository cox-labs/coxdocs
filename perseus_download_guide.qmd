...
**Install .NET Framework 4.7.2 or higher** - To find out whether you already have it, follow the instructions on [How to Determine Which .NET Framework Versions Are Installed](http://msdn.microsoft.com/en-us/library/hh925568%28v=vs.110%29.aspx#net_b).
If you need to, you can download the software and get installation instructions at the [Microsoft Download Center](http://www.microsoft.com/en-us/download/details.aspx?id=30653).
