...
This activity examines if annotation terms are enriched in certain phases of a periodic process and assigns a phase and a p-value to each annotation term.
...
![](images/time_series-cyclic_annotation_enrichment-edited.png)

{{ perseus:user:activities:matrixprocessing:timeseries:time_series-cyclic_annotation_enrichment-edited.png?direct \|Pop-up window: cyclic annotation enrichment}}
