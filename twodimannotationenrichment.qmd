...
For every term in the categorical columns it is tested whether the corresponding expression values have a distribution in two-dimensional planes of expression values that is deviating from the global distribution. For details see Cox and Mann (2012) [@cox2012] .
...
![](images/annot.columns-2d_annotation_enrichment-edited.png)
