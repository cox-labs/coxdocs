...
If you need to, you can download the software and get installation instructions at the [for .NET 7.0 here](https://dotnet.microsoft.com/en-us/download/dotnet/8.0).
